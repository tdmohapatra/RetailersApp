<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditProductInvoicePage.aspx.cs" Inherits="RetailersApp.EditProductInvoicePage" %>
        ...
        <div>
            ...
            <table>
                ...
                <tr>
                 ...
                 <tr>
                    <td></td>
                    <td><asp:Button ID="btnRegister" Text="UPDATE" runat="server" OnClick="btnRegister_Click"/></td>
